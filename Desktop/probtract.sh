...
#wdt reconstruction
$cdir/wdtfit $out/tractography/${IDs}_i2v.Bfloat $out/tractography/${IDs}.scheme -bgmask ${out}/AMICO/dwibet_mask.nii.gz -outputfile $out/tractography/${IDs}_WdtModelFit.Bdouble
